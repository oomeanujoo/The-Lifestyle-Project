...
- **Third microservice, `integration-service`, added 2026-09-16** (same
  ...
  **`travel-service`/`property-service` do not call `integration-service`
  ...
  `TECHNICAL_ARCHITECTURE.md` §13 for why. Required environment variables
